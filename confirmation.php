...
<body>
    <div class="confirmation-container">
        ...
        <p>Your darshan tickets have been booked successfully.</p>
        <!-- Download Ticket Button -->
        <a id="downloadButton" href="download_ticket.php?temple_id=<?= urlencode($templeId) ?>&booking_id=<?= urlencode($bookingId) ?>" onclick="handleDownload()">Download Ticket as PDF</a>
        ...
        <div id="notification" class="notification">
            Ticket downloaded successfully! You can now return to the home page.
        </div>
    </div>
